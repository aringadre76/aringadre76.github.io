            ...
            <ElectricBorder color="#3b82f6" thickness={2} className="mb-4">
              <SimpleCard>
                <p className="card-text">
                  Hello everyone! I’m Arin, a recent graduate in Computer
                  Engineering from UC Santa Cruz, passionate about building
                  scalable applications and exploring new technologies. I’m
                  actively seeking new grad opportunities where I can contribute
                  my skills in software development and system optimization to
                  transformative projects.
                </p>

                <p className="card-text">
                  Current projects I’m actively working on include the Baseball
                  Stats MCP Server — a comprehensive baseball analytics MCP
                  server exposing 32 analysis tools and real-time MLB/Statcast
                  integrations; the OpenBiomechanics injury risk assessment
                  pipeline (ML-based pitcher injury prediction with 195+
                  biomechanical features); and the Scholarly Research MCP Server
                  for consolidated academic search and analysis. I’m focused on
                  production-ready tooling, observability, and making
                  research-grade analytics accessible via APIs and MCP tools.
                </p>

                <p className="card-text">
                  Recent experience: at Nutanix I built a containerized CPU
                  benchmarking platform for LLM inference with Docker Compose,
                  added a Streamlit UI for 10+ models, and instrumented
                  Prometheus/Grafana with a SQLite backend—raising deployment
                  consistency to 95% and enabling data-driven performance
                  analysis. At The Difference I architected Flutter components,
                  integrated eight third‑party APIs, and implemented GitHub
                  Actions CI/CD to speed and stabilize deployments.
                </p>

                <p className="card-text">
                  With expertise across Python, C++, React, Flutter, Django, and
                  ML frameworks, I enjoy turning complex systems into reliable
                  products. Let’s connect and build something impactful.
                </p>
              </SimpleCard>
            </ElectricBorder>
          </div>
...
const projectsData = [
    ...
    links: [
      {
        ...
        url: "https://github.com/aringadre76/bingeflix-backend",
      },
      {
        label: "Frontend GitHub",
        url: "https://github.com/aringadre76/bingeflix-frontend",
      },
      { label: "Live Demo", url: "https://bingeflixstreaming.vercel.app/" },
      {
        label: "Video Demo",
        url: "https://www.youtube.com/watch?v=WiLgSWHEQ1E",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: "Demo Video",
        url: "https://www.youtube.com/watch?v=A_kBcON_fjk",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "Frontend GitHub",
        url: "https://github.com/aringadre76/real-time-drawing-board-frontend",
      },
      {
        label: "Backend GitHub",
        url: "https://github.com/aringadre76/real-time-drawing-board-backend-deploy",
      },
      {
        label: "Live Demo",
        url: "https://real-time-drawing-board-front-deploy.vercel.app/",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/aringadre76/mcp-for-research",
      },
      {
        label: "NPM",
        url: "https://www.npmjs.com/package/scholarly-research-mcp",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/aringadre76/amazon-link-cleaner",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/aringadre76/distributed-task-queue",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/aringadre76/ImageClassifcationModel",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/aringadre76/baseball-injury-risk-assessment/",
      },
    ],
  },
];
...
function renderProjectLinks(
  ...
  const items =
    links && links.length > 0
      ? links
      : singleLink
        ? [{ label: "Repository", url: singleLink }]
        : [];
...
function renderProjectExtras(
  extras?: { label: string; value?: string; link?: string }[],
) {
      ...
      <div className="container">
        <div className="section">
          ...
          <SimpleCard>
            ...
            <SimpleButton
              onClick={() => toast.success("Resume download coming soon!")}
            >
              Download PDF
            </SimpleButton>
          </SimpleCard>
        ...
        {isMobile ? (
          ...
          <div className="gooey-nav-wrapper">
            <GooeyNavRouter
              items={navItems}
              initialActiveIndex={
                getCurrentActiveIndex() >= 0 ? getCurrentActiveIndex() : 0
              }
              animationTime={450}
              particleCount={6}
